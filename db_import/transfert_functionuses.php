...
$sql = 'insert into ethnodoc.functionuse (id,functionUse)SELECT cle_fonction,fonction
			from raddo.c_fonction;
		UPDATE ethnodoc.functionuse SET functionUse=replace(functionUse,"\'","_");
		insert into functionUse(functionUse_id, canton) value (0,"inconnu");';
