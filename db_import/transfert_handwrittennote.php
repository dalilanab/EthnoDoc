...
$sql = 'insert into ethnodoc.handwrittennote (consultation, cle_reel, title, date, url, decenie_id, locality_id, language, holder_id, collection_id, culture, leadInCoupletFR, leadInRefrainFR, leadInCoupletVO, leadInRefrainVO, authorAncient, traditionalAuthor, 
