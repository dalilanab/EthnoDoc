...
$sql = "insert into ethnodoc.handwrittennote_keyword (handwrittennote_id, keyword_id)
                
        select ethnodoc.handwrittennote.handwrittennote_id, donneesraddo.document_global_mot_cle.cle_mot
		...
		from ((donneesraddo.document_global
			...
			left join ethnodoc.handwrittennote on donneesraddo.document_global.cle_document_global = ethnodoc.handwrittennote.cle_reel)

		where donneesraddo.document_global.cle_document = 8";
//Query
